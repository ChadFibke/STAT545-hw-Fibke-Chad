...
I choose box plots because their upper whiskers are sesnistive to large outlier (max population values). However, the red box shows this ordering is specificly ordering the max population and other statistics like the median
