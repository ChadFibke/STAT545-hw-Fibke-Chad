...
I have already reordered countries by max population size, but lets add some size as well to reinforce the idea that larger tells us more people are found in these countries so we don't have to look at the y-axis:
...
![](HW05_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-7-1.png) Other coloring methods have been used in this report as well!
