...
``` r
ggsave(filename="Redhot.png", plot = Redhot, width = 15, height = 23, units = "cm", device = "png")
```

And finally I'll attach it below: ![Alt text](%22/Users/chadfibke/Desktop/Redhot.png%22)
